...
const PlayListConfirm = () => {
    ...
    useEffect(() => {
        ...
        const fetchPlaylists = async () => {
            ...
            try {
                const res = await fetch("https://top2000backend.runasp.net/api/PlayList/retrieve", {
                    method: 'GET',
                    headers: {
    ...
    const onConfirm = async (action, playlistId , songId = null) => {
        try {
            if (action === 'add') {
                ...
                const res = await fetch(`https://top2000backend.runasp.net/api/PlayList/add`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${token}`,
            ...
            if (action === 'create') {
                ...
                const res = await fetch('https://top2000backend.runasp.net/api/PlayList/Create', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${token}`,
            ...
            if (action === 'delete') {
                const res = await fetch("https://top2000backend.runasp.net/api/PlayList/remove", {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
