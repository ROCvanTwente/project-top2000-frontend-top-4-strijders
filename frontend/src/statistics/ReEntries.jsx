...
export default function ConnectingPosition() {
    ...
    useEffect(() => {
        fetch(`https://top2000backend.runasp.net/api/Statistieken/GetReturnedSongs?year=${year}`)
            .then(res => res.json())
                ...
                <div className="col-12">
                    <div className="card shadow border-0 p-2">
                        <div className="card-header border-0 bg-white figma-red-text">
                            Liedjes die in {year} terug zijn in top 2000
                        </div>
